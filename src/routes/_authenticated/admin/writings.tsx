...
function WritingsAdmin() {
  return (
    <>
      ...
      <CollectionEditor
        table="writings"
        emptyRow={{ title: "", slug: "", kind: "essay", summary: "", body: "", tags: [], cover_url: "", date: "", url: "" }}
        itemLabel={(r) => r.title}
        fields={[
          { name: "title", label: "Title", kind: "text" },
          { name: "slug", label: "Slug (URL path, optional)", kind: "text" },
          ...
          { name: "cover_url", label: "Cover image URL (optional)", kind: "text" },
